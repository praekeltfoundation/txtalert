...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_changerequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Visit'])),
            ('request', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('core', ['ChangeRequest'])


    def backwards(self, orm):
        
        # Deleting model 'ChangeRequest'
        db.delete_table('core_changerequest')
