...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChangeRequest.created_at'
        db.add_column('core_changerequest', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 6, 21), blank=True), keep_default=False)

        # Adding field 'ChangeRequest.updated_at'
        db.add_column('core_changerequest', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 6, 21), blank=True), keep_default=False)

        # Adding field 'ChangeRequest.status'
        db.add_column('core_changerequest', 'status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChangeRequest.created_at'
        db.delete_column('core_changerequest', 'created_at')

        # Deleting field 'ChangeRequest.updated_at'
        db.delete_column('core_changerequest', 'updated_at')

        # Deleting field 'ChangeRequest.status'
        db.delete_column('core_changerequest', 'status')
