...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_clinicnamemapping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wrhi_clinic_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('clinic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Clinic'])),
        ))
        db.send_create_signal(u'core', ['ClinicNameMapping'])


    def backwards(self, orm):
        # Deleting model 'ClinicNameMapping'
        db.delete_table(u'core_clinicnamemapping')
