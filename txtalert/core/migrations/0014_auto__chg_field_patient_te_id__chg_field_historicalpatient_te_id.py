...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.te_id'
        db.alter_column('core_patient', 'te_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'HistoricalPatient.te_id'
        db.alter_column('core_historicalpatient', 'te_id', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Patient.te_id'
        db.alter_column('core_patient', 'te_id', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))

        # Changing field 'HistoricalPatient.te_id'
        db.alter_column('core_historicalpatient', 'te_id', self.gf('django.db.models.fields.CharField')(max_length=10))
