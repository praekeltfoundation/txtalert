...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patient.name'
        db.add_column('core_patient', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Patient.surname'
        db.add_column('core_patient', 'surname', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'HistoricalPatient.name'
        db.add_column('core_historicalpatient', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'HistoricalPatient.surname'
        db.add_column('core_historicalpatient', 'surname', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.name'
        db.delete_column('core_patient', 'name')

        # Deleting field 'Patient.surname'
        db.delete_column('core_patient', 'surname')

        # Deleting field 'HistoricalPatient.name'
        db.delete_column('core_historicalpatient', 'name')

        # Deleting field 'HistoricalPatient.surname'
        db.delete_column('core_historicalpatient', 'surname')
