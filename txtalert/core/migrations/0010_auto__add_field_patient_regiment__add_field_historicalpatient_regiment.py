...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_patient', 'regiment', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'HistoricalPatient.regiment'
        db.add_column('core_historicalpatient', 'regiment', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.regiment'
        db.delete_column('core_patient', 'regiment')

        # Deleting field 'HistoricalPatient.regiment'
        db.delete_column('core_historicalpatient', 'regiment')
