...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.age'
        db.alter_column('core_patient', 'age', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Patient.language'
        db.alter_column('core_patient', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Language'], null=True))

        # Changing field 'Visit.visit_type'
        db.alter_column('core_visit', 'visit_type', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'HistoricalPatient.language'
        db.alter_column('core_historicalpatient', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Language'], null=True))

        # Changing field 'HistoricalPatient.age'
        db.alter_column('core_historicalpatient', 'age', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'HistoricalVisit.visit_type'
        db.alter_column('core_historicalvisit', 'visit_type', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Patient.age'
        raise RuntimeError("Cannot reverse this migration. 'Patient.age' and its values cannot be restored.")

        # Changing field 'Patient.language'
        db.alter_column('core_patient', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Language']))

        # Changing field 'Visit.visit_type'
        db.alter_column('core_visit', 'visit_type', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'HistoricalPatient.language'
        db.alter_column('core_historicalpatient', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Language']))

        # User chose to not deal with backwards NULL issues for 'HistoricalPatient.age'
        raise RuntimeError("Cannot reverse this migration. 'HistoricalPatient.age' and its values cannot be restored.")

        # Changing field 'HistoricalVisit.visit_type'
        db.alter_column('core_historicalvisit', 'visit_type', self.gf('django.db.models.fields.CharField')(default='', max_length=80))
