...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_visit', 'wrhi_orig_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'HistoricalVisit.wrhi_orig_date'
        db.add_column(u'core_historicalvisit', 'wrhi_orig_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visit.wrhi_orig_date'
        db.delete_column(u'core_visit', 'wrhi_orig_date')

        # Deleting field 'HistoricalVisit.wrhi_orig_date'
        db.delete_column(u'core_historicalvisit', 'wrhi_orig_date')
    ...
    models = {
        ...
        u'core.historicalvisit': {
            ...
            'wrhi_orig_date': ('django.db.models.fields.DateField', [], {'null': 'True'})
        },
        u'core.language': {
