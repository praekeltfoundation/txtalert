...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Visit.te_visit_id'
        db.alter_column(u'core_visit', 'te_visit_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

        # Changing field 'HistoricalVisit.te_visit_id'
        db.alter_column(u'core_historicalvisit', 'te_visit_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Visit.te_visit_id'
        db.alter_column(u'core_visit', 'te_visit_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20, null=True))

        # Changing field 'HistoricalVisit.te_visit_id'
        db.alter_column(u'core_historicalvisit', 'te_visit_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        u'core.historicalpatient': {
            ...
            'history_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 0, 0)'}),
