...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GoogleAccount.user'
        db.add_column('googledoc_googleaccount', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GoogleAccount.user'
        db.delete_column('googledoc_googleaccount', 'user_id')
