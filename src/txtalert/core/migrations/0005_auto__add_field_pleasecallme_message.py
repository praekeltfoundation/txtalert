...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PleaseCallMe.message'
        db.add_column('core_pleasecallme', 'message', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PleaseCallMe.message'
        db.delete_column('core_pleasecallme', 'message')
